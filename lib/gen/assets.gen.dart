...
class $AssetsImagesGen {
  ...
  /// File path: assets/images/techblog_logo.png
  AssetGenImage get techblogLogo =>
      const AssetGenImage('assets/images/techblog_logo.png');

  /// List of all assets
  List<AssetGenImage> get values =>
      [emptyState, posterTest, profileAvatar, singlePlaceHolder, techblogLogo];
}
